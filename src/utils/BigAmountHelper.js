...
export const safeAmountFixed = (amount) => new BigNumber(amount).multipliedBy(10 ** 8)
  .integerValue(BigNumber.ROUND_FLOOR).toFixed();
// Amount used to convert amount from smart contract to number with decimal
export const safeAmountDecimal = (amount) => new BigNumber(amount).div(10 ** 8).toString();
