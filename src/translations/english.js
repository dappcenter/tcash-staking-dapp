...
export default {
  ...
  'Please connect a wallet with your TCASH holdings to start or use the Read only button to check the state of your stake.': 'Please connect a wallet with your TCASH holdings to start or use the Read only button to check the state of your stake.',
  ...
  'Please fill in the amount of TCASH you want to stake.': 'Please fill in the amount of TCASH you want to stake.',
  'Back': 'Back',
  'Next': 'Next',
  'Approve': 'Approve',
  'You need to allow the staking pool to take $TCASH_AMOUNT from your wallet.' : 'You need to allow the staking pool to take $TCASH_AMOUNT from your wallet.',
  'Approving': 'Approving',
  'You can now deposit your TCASH to the staking pool.': 'You can now deposit your TCASH to the staking pool.',
  'Staking': 'Staking',
  'Failed to approve': 'Failed to approve',
  'Failed to stake': 'Failed to stake',
  'Your Tcash token are now staked and you will start collecting fees on all trades !': 'Your Tcash token are now staked and you will start collecting fees on all trades !',
  'Done': 'Done',
  'Are you sure?': 'Are you sure?',
  'All your pending reward will be transferred to your stake.': 'All your pending reward will be transferred to your stake.',
  '$TCASH_AMOUNT will be transferred from your pending reward to your current stake.': '$TCASH_AMOUNT will be transferred from your pending reward to your current stake.',
  'Your pending rewards are now staked.': 'Your pending rewards are now staked.',
  'I understand': 'I understand',
  'Failed to claim': 'Failed to claim',
  'Claiming': 'Claiming',
  'Please fill in the amount of TCASH you want to withdraw.': 'Please fill in the amount of TCASH you want to withdraw.',
  '$TCASH_AMOUNT will be transferred from your stake to your wallet.': '$TCASH_AMOUNT will be transferred from your stake to your wallet.',
